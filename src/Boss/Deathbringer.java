...
public class Deathbringer extends ObjetoComMovimento {

    Sprite sprite;
    int velocidade;
    int vidas;

    public Deathbringer(int x, int y, int velocidade) {
        ...
        this.y = y;
        try {
            this.sprite = new Sprite("resources/boss/db.png", 1, 150, 250);
        } catch (Exception ex) {
