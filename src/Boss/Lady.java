...
public class Lady extends ObjetoComMovimento {
    ...
    public Lady(int x, int y, int velocidade) {
    ...
    public void draw(Graphics g) {
        ...
        g.drawString("Vida:"+this.vidas , this.x + 5, this.y - 20);
        g.drawString("Mana:"+this.mana, this.x+5, this.y-7);
