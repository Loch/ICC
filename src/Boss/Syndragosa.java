...
public class Syndragosa extends ObjetoComMovimento {

    Sprite sprite;
    int velocidade;
    int vidas;

    public Syndragosa(int x, int y, int velocidade) {
        ...
        this.y = y;
        try {
            this.sprite = new Sprite("resources/boss/syndragosa.png", 1, 300, 300);
        } catch (Exception ex) {
