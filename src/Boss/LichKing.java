...
public class LichKing extends ObjetoComMovimento {

    Sprite sprite;
    int velocidade;
    int vidas;

    public LichKing(int x, int y, int velocidade) {
        ...
        this.y = y;
        try {
            this.sprite = new Sprite("resources/boss/loch.png", 2, 205, 150);
        } catch (Exception ex) {
